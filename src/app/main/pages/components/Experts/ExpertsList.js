...
const ExpertsList = props => {
	...
	return (
		<Grid container spacing={2}>
			<Grid item>
				<Typography variant="h4">Эксперты ТО</Typography>
			</Grid>
			<Grid item container>
				<Button className="text-white bg-green-500" variant="contained">
					Добавить
				</Button>

				<Button className="text-white bg-gray-600 ml-10" variant="contained">
					Импорт из ЕАИСТО
				</Button>
			</Grid>
