			...
			<Grid direction="column" container spacing={2}>
					...
					{[1, 1].map((elem, i) => (
						<Grid key={i} item xs={12} sm={6}>
							<Paper component="form" className={classes.root} onSubmit={handleSubmit}>
								<InputBase className={classes.input} placeholder="Фото ТС до осмотра" />
							...
							<div
								className={clsx(
									classes.photoWrap,
									'bg-green-400 mt-16 flex justify-center items-center'
								)}
							>
								ФОТО
							</div>
				...
				<Grid item>
					<Card>
						<CardContent>
							<Grid>
								<Typography variant="body1">Заполнение карты по vin и госномеру</Typography>
							</Grid>
				...
				<Grid item container spacing={3}>
					<Grid item>
						<Typography variant="h4">Лицо, представившее ТС для проведения ТО</Typography>
					</Grid>
					<Grid item container>
						<Grid item xs={3}>
							<Typography className="font-bold" variant="body1">
				...
				<Grid item container spacing={3}>
					<Grid item>
						<Typography variant="h4">Сведения о ТС</Typography>
					</Grid>
					<Grid item container>
						<Grid item xs={3}>
							<Typography className="font-bold" variant="body1">
						...
						<Grid item xs={3}>
							...
							<FormControl variant="outlined" className={classes.formControl}>
								...
								<Select labelId="select-label" label="autocomplete">
									<MenuItem value="">
										<em>None</em>
									</MenuItem>
					...
					<Grid item container>
						...
						<Grid item xs={3}>
							...
							<FormControl variant="outlined" className={classes.formControl}>
								...
								<Select labelId="select-label" label="Бензин">
									<MenuItem value="">
										<em>None</em>
									</MenuItem>
									<MenuItem value={10}>Ten</MenuItem>
						...
						<Grid item xs={3}>
							...
							<FormControl variant="outlined" className={classes.formControl}>
								...
								<Select labelId="select-label" label="Гидравлическая">
									<MenuItem value="">
										<em>None</em>
									</MenuItem>
									<MenuItem value={10}>Ten</MenuItem>
					...
					<Grid item container>
						<Grid item xs={3}>
							...
							<FormControl variant="outlined" className={classes.formControl}>
								...
								<Select labelId="select-label" label="Личная">
									<MenuItem value="">
										<em>None</em>
									</MenuItem>
									<MenuItem value={10}>Ten</MenuItem>
